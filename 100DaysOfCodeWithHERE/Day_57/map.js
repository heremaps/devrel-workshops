...
var style = new H.map.Style('styles/font_arial.yaml',
...
var positionIcon = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="20px" height="20px" viewBox="-0.5 -0.5 21 21"><defs/><g><ellipse cx="10" cy="10" rx="10" ry="10" fill="#009900" stroke="#000000" pointer-events="none"/><ellipse cx="10" cy="10" rx="3" ry="3" fill="#ffffff" stroke="#000000" pointer-events="none"/></g></svg>`;
...
function getBrowserPosition(){
    ...
    if(navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(position => {
                ...
                console.log('My position ='+JSON.stringify(browserPosition));
...
function clickToMark(){
    ...
    map.addEventListener('tap', function(evt) {
        if(evt.target instanceof H.map.Marker){
            ...
            console.log('roboPosition = '+ JSON.stringify(pointerPosition))
...
function drawBox(){
    ...
    var rect = new H.map.Rect(new H.geo.Rect(52.47149171,13.377776,52.4685620,13.3862457),{
        style:{
            strokeColor:'red',
